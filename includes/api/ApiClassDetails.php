...
class ApiClassDetails extends \ApiQueryBase {
	...
	public function execute() {
        ...
        ->select(['student_id', 'u.user_name', 't.task_id', 't.task_name', 't.task_type', 't.task_subject', 't.task_description',
        't.task_reference_link', 't.task_criteria', 't.page_name', 'task_status', 'task_feedback', 'task_result'])
